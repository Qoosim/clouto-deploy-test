          ...
          <form className="bg-[#D9D9D9] flex flex-col gap-[3rem] font-inter w-full">
            <div className="text-[#000] w-full flex flex-col items-center gap-[1rem]">
              <h2 className="text-[#000] font-bold text-[1.1rem]">
                PLEASE CONFIRM YOUR ACCOUNT DETAILS CORRECTLY
              </h2>
              <div className="w-[70%] flex flex-col gap-[3rem]">
                ...
                <div className="flex justify-between mt-[1rem] w-full">
                  <button
                    className="bg-[#00ff57] text-[#000] font-bold px-[1rem] py-[0.3rem]"
                    onClick={(e) => {
                      e.preventDefault();
                      onNext();
                    }}
                  ...
                  <button
                    className="bg-[#fff] text-[#000] font-bold px-[1rem] py-[0.3rem]"
                    onClick={(e) => {
                      e.preventDefault();
                      onNext();
                    }}
