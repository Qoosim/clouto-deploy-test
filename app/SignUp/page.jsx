...
import { signUpSchema } from "@/redux/utils/validations";
      ...
      <div className="relative z-10 flex flex-col min-h-screen px-6 py-8">
        ...
        <div className="max-w-md mx-auto w-full space-y-6 text-center">
          ...
          <form onSubmit={handleSubmit(formSubmit)} className="space-y-2">
            <label className="block text-center text-sm mb-6 text-gray-300">
              Enter Email
            </label>
            <div className="relative">
              ...
              <button
                type="submit"
                className="absolute right-2 top-1 bottom-1 bg-green-400 text-black text-[12px] font-semibold px-4 my-[3px] rounded flex items-center justify-center"
              >
          ...
          <p className="text-gray-300 text-sm">
            ...
            <Link href="SignIn">
              <button className="text-[#0AFF5B] ml-2 hover:underline">
                Sign In
              </button>
            </Link>
          </p>
